...
export const comparabilityRenderer = (
  ...
  // Add click handler to open the comparability tab
  container.addEventListener('click', (e) => {
    e.stopPropagation();
    // Get the column definition to determine which subtab to open
    if (cellProperties?.cfFactor) {
      openComparabilityTab(rowData, cellProperties.cfFactor);
    } else {
      openComparabilityTab(rowData);
    }
  });
